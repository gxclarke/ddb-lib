...
weight: 90
description: "Learn how to contribute to ddb-lib documentation and codebase"
type: docs
---
...
- [Development Setup](/contributing/setup/) - Set up your local development environment
- [Documentation Guide](/contributing/documentation/) - Learn how to write and update documentation
- [Code of Conduct](https://github.com/yourusername/ddb-lib/blob/main/CODE_OF_CONDUCT.md) - Our community guidelines
...
See our [Documentation Guide](/contributing/documentation/) for detailed instructions.
...
See our [Development Setup](/contributing/setup/) guide to get started.
...
We are committed to providing a welcoming and inclusive environment for all contributors. Please read and follow our [Code of Conduct](https://github.com/yourusername/ddb-lib/blob/main/CODE_OF_CONDUCT.md).
...
Thank you for making ddb-lib better! 🎉
