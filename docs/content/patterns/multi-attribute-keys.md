...
{{< pattern-diagram mermaid="true" caption="Multi-Attribute Key Structure" >}}
graph LR
...
{{< pattern-diagram mermaid="true" caption="Query Flexibility" >}}
graph TD
    Root[Query Level]
...
{{< code-example lang="typescript" title="Creating Multi-Attribute Keys" >}}
import { 
  multiAttributeKey,
  multiTenantKey,
...
{{< code-example lang="typescript" title="Multi-Attribute Keys with TableClient" >}}
...
{{< code-example lang="typescript" title="GSI with Multi-Attribute Keys" >}}
...
{{< code-example lang="typescript" title="Multi-Tenant Data Isolation" >}}
import { multiTenantKey } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="Location-Based Queries" >}}
...
{{< code-example lang="typescript" title="Product Categorization" >}}
...
{{< code-example lang="typescript" title="Categorized Time-Series Data" >}}
...
{{< code-example lang="typescript" title="Document Versioning" >}}
...
- [Composite Keys](/patterns/composite-keys/) - String-based alternative
- [Hierarchical](/patterns/hierarchical/) - Tree structures
- [Entity Keys](/patterns/entity-keys/) - Simple entity identification
- [Time-Series](/patterns/time-series/) - Time-based data
