...
{{< pattern-diagram mermaid="true" caption="Composite Key Structure" >}}
graph LR
    A[Part 1] -->|#| B[Part 2]
    B -->|#| C[Part 3]
...
{{< pattern-diagram mermaid="true" caption="Querying with Composite Keys" >}}
graph TD
...
{{< code-example lang="typescript" title="Creating Composite Keys" >}}
...
{{< code-example lang="typescript" title="Parsing Composite Keys" >}}
import { PatternHelpers } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="Composite Keys with TableClient" >}}
...
{{< code-example lang="typescript" title="Time-Series with Categories" >}}
import { PatternHelpers } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="Multi-Tenant Application" >}}
import { PatternHelpers } from '@ddb-lib/core'
...
- [Entity Keys](/patterns/entity-keys/) - Foundation for composite keys
- [Time-Series](/patterns/time-series/) - Time-based composite keys
- [Hierarchical](/patterns/hierarchical/) - Hierarchical composite keys
