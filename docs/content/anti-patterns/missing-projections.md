...
{{< comparison-table 
  good-title="✅ With Projection"
  bad-title="❌ Without Projection"
  good="Read only needed attributes\n1 KB transferred\n1 RCU consumed\nFast response"
  bad="Read entire item\n10 KB transferred\n3 RCU consumed\nSlow response"
  explanation="Projection expressions reduce capacity consumption by 50-90% depending on item size and attributes needed." />}}
...
- [Projection Expressions Best Practice](/best-practices/projection-expressions/)
