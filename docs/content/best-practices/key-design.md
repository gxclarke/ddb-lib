...
- [Query vs Scan](/best-practices/query-vs-scan/) - Efficient queries depend on good keys
- [Capacity Planning](/best-practices/capacity-planning/) - Key design affects capacity needs
- [Conditional Writes](/best-practices/conditional-writes/) - Use keys in conditions

## Related Patterns

- [Entity Keys](/patterns/entity-keys/) - Type-safe entity identification
- [Composite Keys](/patterns/composite-keys/) - Multi-attribute keys
- [Hierarchical Keys](/patterns/hierarchical/) - Model relationships
- [Hot Partition Distribution](/patterns/hot-partition-distribution/) - Prevent hot partitions
