...
{{< code-example lang="bash" title="Initialize Project" >}}
mkdir task-manager
cd task-manager
npm init -y
...
{{< code-example lang="typescript" title="src/types.ts" >}}
...
{{< code-example lang="typescript" title="src/db.ts" >}}
...
{{< code-example lang="typescript" title="src/users.ts" >}}
import { db } from './db'
import { PatternHelpers } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="src/projects.ts" >}}
import { db } from './db'
import { PatternHelpers } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="src/tasks.ts" >}}
import { db } from './db'
import { PatternHelpers } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="src/activities.ts" >}}
import { db } from './db'
import { PatternHelpers } from '@ddb-lib/core'
...
{{< code-example lang="typescript" title="src/index.ts" >}}
...
{{< code-example lang="bash" title="Run the Application" >}}
