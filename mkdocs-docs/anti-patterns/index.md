...
### [string concatenation for keys](string-concatenation.md)
...
### [missing projections](missing-projections.md)
...
### [inefficient batching](inefficient-batching.md)
...
1. **[Table Scans](table-scans.md)** - Massive performance and cost impact
2. **[Hot Partitions](hot-partitions.md)** - Causes throttling and prevents scaling

### High priority (fix soon)
3. **[Read-Before-Write](read-before-write.md)** - Data integrity and performance issues
4. **[Missing Projections](missing-projections.md)** - Significant cost waste

### Medium priority (optimize when possible)
5. **[Inefficient Batching](inefficient-batching.md)** - Performance optimization
6. **[String Concatenation](string-concatenation.md)** - Code quality and maintainability
