...
- [Entity Keys](entity-keys.md) - Foundation for adjacency lists
- [Composite Keys](composite-keys.md) - Build relationship keys
- [Hierarchical](hierarchical.md) - For tree structures
- [Sparse Indexes](sparse-indexes.md) - Index specific relationships
