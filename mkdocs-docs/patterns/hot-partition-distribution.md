...
**Distributed Writes with TableClient**
...
- [Entity Keys](entity-keys.md) - Foundation for distributed keys
- [Composite Keys](composite-keys.md) - Combine with sharding
- [Time-Series](time-series.md) - Often needs sharding for high volume
- [Sparse Indexes](sparse-indexes.md) - Alternative for read optimization
